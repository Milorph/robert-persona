...
const ITEMS = [
  {
    id: "twitch", label: "WHO I AM", handle: "@yourname", href: "https://twitch.tv/yourname", icon: "🎮", bars: 1, newBars: [0], counts: ["56"],
  ...
  {
    id: "instagram", label: "EDUCATION + EXPERIENCE", handle: "@yourhandle", href: "https://instagram.com/yourhandle", icon: "📷", bars: 5, newBars: [1, 2], counts: ["3.4M", "2.5M", "676K", "412K", "198K"],
