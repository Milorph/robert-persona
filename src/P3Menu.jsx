...
const ITEMS = [
  ...
  { id: "github",  label: "GITHUB LINK",   page: "github",  fontSize: 62, offsetX: 8,  offsetY: 0, skew: -4,  skewY: 7  },
  { id: "socials", label: "SOCIALS",       page: "socials", fontSize: 66, offsetX: 16, offsetY: 0, skew: -8,  skewY: -7 },
  { id: "journey", label: "MY JOURNEY",    page: "journey", fontSize: 56, offsetX: 10, offsetY: 0, skew: -5,  skewY: 7  },
  { id: "talk",    label: "TALK TO ME",    page: "talk",    fontSize: 58, offsetX: 4,  offsetY: 0, skew: -9,  skewY: -7 },
];
          ...
          {ITEMS.map((item, i) => {
            ...
            return (
              <a
                ...
                onMouseMove={() => { if (active !== i) activate(i); }}
