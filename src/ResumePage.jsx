...
const DETAILS = [
  {
    ...
    bullets: [
      ...
      "- Teaching assistant for ECE and CSC courses, covering coding, debugging, and circuit design.",
    ],
  },
  {
    index: "02",
    ...
    progress: "",
    rows: [
      { index: "01", title: "ML: PyTorch / HuggingFace / Sklearn", status: "Primary" },
      { index: "02", title: "Data: NumPy / Pandas / LightGBM", status: "Expert" },
      { index: "03", title: "Languages: Py / C++ / Java / C# / TS", status: "Expert" },
      { index: "04", title: "Backend: Node / ASP.NET / AWS", status: "Advanced" },
    ],
    bullets: [
  ...
  },
  {
    ...
    bullets: [
      "- Four-stage RAG pipeline using DeBERTa-v3 and MiniLM cross-encoders on MNLI, ANLI, and FEVER.",
      "- Reimplemented PM-LSH approximate nearest-neighbor search from the original research.",
      "- The full archive is available in the GitHub section.",
    ],
  },
  {
    index: "04",
